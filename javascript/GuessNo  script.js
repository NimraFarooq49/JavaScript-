...
console.log(document.querySelector(".guess").nodeValue); let secretNumber =
Math.trunc(Math.random() * 20) + 1; let score = 20;
...
document.querySelector(".message").textContent = "no number!"; //when player
wins } else if (guess === secretNumber) {
document.querySelector(".message").textContent = "correct number!";
document.querySelector(".number").textContent = secretNumber;
document.querySelector("body").style.backgroundColor = "#f4f813ff";
document.querySelector(".number").style.width = "30rem"; //when guess is too
...
document.querySelector(".score").textContent = 0; } } //when guess is too low
