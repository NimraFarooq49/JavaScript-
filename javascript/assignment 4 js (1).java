...
let population = 10; // Original population in millions

console.log(
  ${country}'s population is ${population > 33 ? 'above' : 'below'} average
);

// Now test with population = 13
population = 13;
console.log(
  ${country}'s population is ${population > 33 ? 'above' : 'below'} average
);

// Now test with population = 130
population = 130;
console.log(
  ${country}'s population is ${population > 33 ? 'above' : 'below'} average
);
...
const desc2 = describeCountry('Pakistan', 240, 'Islamabad');
const desc3 = describeCountry('Japan', 125, 'Tokyo');
